        ...
        <div class="container-fluid px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link px-3" href="#">Fitur</a></li>
                    <li class="nav-item"><a class="nav-link px-3" href="#">Tentang</a></li>
                    <li class="nav-item"><a class="nav-link px-3" href="#">Kontak</a></li>
                </ul>
                <div class="d-flex gap-3">
                    <button class="btn btn-outline-light px-4 border-2 fw-bold">Masuk</button>
                    <button class="btn btn-light px-4 fw-bold" style="color: #10367d;">Daftar</button>
                </div>
            </div>
        </div>
    </nav>
